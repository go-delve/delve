...
func MakeGuessSusbtitutePathIn() (*GuessSubstitutePathIn, error) {
	...
	return &GuessSubstitutePathIn{ModuleDirectories: mod2dir}, nil
}
...
func (c *RPCClient) GuessSubstitutePath() ([][2]string, error) {
	...
	err = c.call("GuessSubstitutePath", *in, out)
	return out.List, err
}
