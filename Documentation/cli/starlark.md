...
raw_command(Name, ThreadID, GoroutineID, ReturnInfoLoadConfig, Expr, SkipCalls, UnsafeCall) | Equivalent to API call [Command](https://godoc.org/github.com/go-delve/delve/service/rpc2#RPCServer.Command)
