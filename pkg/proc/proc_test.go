...
func TestChainedBreakpoint(t *testing.T) {
	...
	withTestProcess("bphitcountchain", t, func(p *proc.Target, grp *proc.TargetGroup, fixture protest.Fixture) {
		...
		assertNoError(grp.ChangeBreakpointCondition(lbp2, fmt.Sprintf("runtime.bphitcount[%d] > 0", lbp1.LogicalID), "== 1", false), t, "ChangeBreakpointCondition")
		assertNoError(grp.ChangeBreakpointCondition(lbp3, fmt.Sprintf("runtime.bphitcount[%d] > 0", lbp2.LogicalID), "== 1", false), t, "ChangeBreakpointCondition")
