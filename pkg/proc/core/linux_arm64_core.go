...
//yyy Note: The comment lines "//yyy" were introduced to get this file to
//yyy       complile inside the main delve branch.  At some point, these
//yyy       fuctions (or their equivalents) should be implemented.
...
func readLinuxARM64Core(corePath, exePath string) (*Process, error) {
	...
	for _, note := range notes {
		...
		case NT_X86_XSTATE_arm64:
			if lastThread != nil {
//yyy 			lastThread.regs.Fpregs = note.Desc.(*linutil.ARM64Xstate).Decode()
			}
...
func readNote_arm64(r io.ReadSeeker) (*Note_arm64, error) {
	...
	case NT_FILE_arm64:
		...
		note.Desc = data
	case NT_X86_XSTATE_arm64:
//yyy 	var fpregs linutil.ARM64Xstate
//yyy 	if err := linutil.ARM64XstateRead(desc, true, &fpregs); err != nil {
			return nil, err
//yyy 	}
//yyy 	note.Desc = &fpregs
	case NT_AUXV_arm64:
		note.Desc = desc
	}
	if err := skipPadding_arm64(r, 4); err != nil {
...
//yyy 		return linutil.EntryPointFromAuxvARM64(note.Desc.([]byte))
		}
	}
	return 0
}
