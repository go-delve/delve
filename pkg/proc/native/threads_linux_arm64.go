...
func (t *Thread) restoreRegisters(savedRegs proc.Registers) error {		
		...
		var restoreRegistersErr error =nil				
		...
		_, _, restoreRegistersErr = syscall.Syscall6(syscall.SYS_PTRACE, sys.PTRACE_SETREGSET, uintptr(t.ID), uintptr(0), uintptr(unsafe.Pointer(&sr.Fpregset.ARM64PtraceFpRegs)), 0, 0)
		return
	})
