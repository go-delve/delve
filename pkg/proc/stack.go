...
func (it *stackIterator) Next() bool {
	...
	if it.opts&StacktraceSimple == 0 {
		switch it.bi.Arch.(type) {
		case *AMD64:
			if amd64switchStack(it) {
				return true
			}
		case *ARM64:
			if arm64switchStack(it) {
				return true
			}
		}
	}
...
func amd64switchStack(it *stackIterator) bool {
...
func (it *stackIterator) switchSp() bool {
...
func arm64switchStack(it *stackIterator) bool {
	if it.frame.Current.Fn == nil {
		return false
	}
	switch it.frame.Current.Fn.Name {
